...
public class Home_Frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Retrofit retrofit = new Retrofit.Builder().baseUrl("https://api.flickr.com/services/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        MyApi api=retrofit.create(MyApi.class);
        Call<MyPojo> call =api.getData();
        call.enqueue(new Callback<MyPojo>() {
            ...
            public void onResponse(Call<MyPojo> call, Response<MyPojo> response) {
                ...
                MyPojo details=response.body();
                Photos photos=details.getPhotos();
...
title=ele.getTitle();
img=ele.getUrl_s();
mData.add(new Model(img,title));


                }
                Log.v("Hi",String.valueOf(mData.size()));
